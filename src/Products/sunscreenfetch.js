...
const Sunscreenfetch = ({ showFilters = true, limit, addToCart, filter }) => {
...
useEffect(() => {
axios
.get("https://omega-zg6z.onrender.com/fetchsunscreen")
.then((response) => {
...
export default connect(null, { addToCart })(Sunscreenfetch);