...
const Facewashfetch = ({ showFilters = true, limit, addToCart, filter }) => {
...
useEffect(() => {
axios
.get("https://omega-zg6z.onrender.com/fetchFacewash")
.then((response) => {
...
export default connect(null, { addToCart })(Facewashfetch);
