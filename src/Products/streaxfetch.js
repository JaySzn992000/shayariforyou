...
const Streaxfetch = ({ showFilters = true, limit, addToCart, filter }) => {
...
useEffect(() => {
axios
.get("https://omega-zg6z.onrender.com/fetchstreax")
.then((response) => {
...
export default connect(null, { addToCart })(Streaxfetch);