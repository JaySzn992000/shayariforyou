...
const Haircolorfetch = ({ showFilters = true, limit, addToCart, filter }) => {
...
useEffect(() => {
axios
.get("https://omega-zg6z.onrender.com/fetchhaircolor")
.then((response) => {
...
export default connect(null, { addToCart })(Haircolorfetch);