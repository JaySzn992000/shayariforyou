...
const Hairserumfetch = ({ showFilters = true, limit, addToCart, filter }) => {
...
useEffect(() => {
axios
.get("https://omega-zg6z.onrender.com/fetchhairserum")
.then((response) => {
...
export default connect(null, { addToCart })(Hairserumfetch);