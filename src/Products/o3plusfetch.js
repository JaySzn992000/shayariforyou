...
const O3plusfetch = ({ showFilters = true, limit, addToCart, filter }) => {
...
useEffect(() => {
axios
.get("https://omega-zg6z.onrender.com/fetcho3plus")
.then((response) => {
...
export default connect(null, { addToCart })(O3plusfetch);