...
const Facecreamfetch = ({ showFilters = true, limit, addToCart, filter }) => {
...
useEffect(() => {
axios
.get("https://omega-zg6z.onrender.com/fetchfacecream")
.then((response) => {
...
export default connect(null, { addToCart })(Facecreamfetch);